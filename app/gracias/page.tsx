        ...
        >
          ...
          <div className="space-y-3 text-sm text-gray-400 text-left">
            ...
            <div className="flex items-start gap-3">
              ...
              <span>Recibirás un email con tu reporte completo en formato PDF en los próximos 10-30 minutos.</span>
            </div>
            <div className="flex items-start gap-3">
              ...
              <span>Si tienes dudas, escríbenos a <span className="text-purple-400">contacto@astralevolution.com</span></span>
            </div>
          </div>
        </div>
